...
export function Button({
  ...
  const classes = `inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-[13px] font-medium tracking-wide transition-colors ${variants[variant]} ${className}`;
